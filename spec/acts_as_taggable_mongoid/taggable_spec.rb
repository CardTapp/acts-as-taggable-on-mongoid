...
RSpec.describe ActsAsTaggableOnMongoid::Taggable do
  describe "Taggable To Preserve Order" do
    ...
    it "should return tag objects in the order the tags were created" do
      ...
      # tags are returned in their create order, not the taggings.
      expect(taggable.tags.map(&:name)).to eq(%w[pow ruby rails css])
    end
  ...
  describe "Taggable" do
    ...
    it "should be able to remove tags through list alone" do
      pending("Refactor/redesign changed this.  May or may not change to match ActsAsTaggableOn based on need/requests.")
