  ...
  module Taggable
    module Core
      ...
      def tag_list_cache_on(tag_type_definition)
        variable_name = "@#{tag_type_definition.tag_list_name}"
      ...
      def tags_on(tag_type_definition)
        ...
        # scope = taggings.where(context: tag_type_definition.tag_type, tagger_id: nil)
        scope = taggings.where(context: tag_type_definition.tag_type)
